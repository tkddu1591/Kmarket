...
public class ListController extends HttpServlet {
	...
	private static final long serialVersionUID = -825480392326787984L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 전체 게시물 갯수
        int total = noticeService.selectCsNoticeCount(cate1);
        ...
        // 현재 페이지 게시물 조회
        List<KmCsNoticeDTO> noticeList = noticeService.selectCsNoticeList(cate1, start);
