...
public class SetCategoryController extends HttpServlet{	
	...
	private KmProductCartService service = KmProductCartService.INSTANCE;
...
/*
		...
		//1차 카테고리 data 
		List<KmCsCate1DTO> cate1item = service.selectCate;
	...
	*/	
		...
		//2차 카테고리 data
		List<KmProductCate2DTO> cate2item = service.selectCSCate2s(dto1.getCate1());
