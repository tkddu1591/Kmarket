					...
					<section>
						<table>
							...
							<tr>
								...
								<td><input type="text" name="km_online_reg"
							...
							<tr>
								...
								<td><input type="text" name="km_tel" placeholder="전화번호 입력"
									required /> <span class="msgTel">&nbsp;&nbsp;- 표시 포함,
										지역번호 포함, 예) 02-234-1234</span></td>
							</tr>
							<tr>
								<th><span class="essential">*</span>팩스번호</th>
								<td><input type="text" name="km_fax" placeholder="팩스번호 입력"
